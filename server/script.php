...
if ( isset($_REQUEST['todo']) ){
  ...
  switch($todo){
    ...
    case 'readmovies': // on veut lire la liste des films
      $data = readMoviesController();
      break;

    case 'postMovie': // on veut ajouter un film
      $data = updateController();
      break;
    
    case 'readMovieDetail': // on veut lire les détails d'un film
      $data = readMovieDetailController();
      break;

    case 'readMovieCategory': // on veut lire la liste des catégories de films
      $data = readMovieCategoryController();
      break;

    case 'addProfile': // on veut ajouter un profil
